canvas = document.getElementById('momGram');
...
ctx.fillText("Thank you so much to everyone at the DAE!", width / 2, height / 2 - 100);
ctx.font = "20px Courier";
ctx.fillText("Click the Start Button to start up your thank you gram", width / 2, height / 2);
var firstFrame = 0;
var cList = [];
var red = 200;
var blue = 180;
var green = 80;
var spawnRateConfetti = 20;
var subtractNum = 100;
var jY = 5;
var jX = 5;
var intervalId = null;
...
function animation() {
  ...
  if (firstFrame < 1401) {
    ...
    ctx.fillStyle = "Red";
    ctx.fillText("Thank you: Jeff, Will, and Rob!", -1200 + firstFrame, 100);
    ctx.fillStyle = "Orange";
    ctx.fillText("Olivia, Emily, Ava & Ian", 1200 - firstFrame, 200);
    ctx.fillStyle = "Green";
